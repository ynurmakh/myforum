...
type _4Posts interface {
	...
	// READY TO USE
	SelectLastPostsByCount(start, end int, thisUser *models.User) (*[]models.Post, int, error)
	// READY TO USE
	FilteredSelectLastPostsByCount(start, end int, thisUser *models.User, cats []int) (*[]models.Post, int, error)
	// READY TO USE
